...
def validate(validation_params):
    ...
    init_state_0_c = placeholders['init_state_0_c']
    init_state_0_h = placeholders['init_state_0_h']
...
def train(train_params):
    ...
    with tf.Session() as sess:
        ...
        for epoch in tqdm.tqdm(range(num_epochs)):
            ...
            validation_params['placeholders'] = {'x': x, 'y': y,
                'init_state_0_c': init_state_0_c, 'init_state_0_h': init_state_0_h}
            sess_params = dict()
